...
def offer(recs):
    ...
    return "\n".join([
        ...
        "",
        "Almost nobody does. I read the product pages of 84 Gumroad storefronts with",
        "this same pay-step gap and checked what each one says about tax: 3 of",
        "them mention it. 81 say nothing at all -- not the word tax, not the word",
        "VAT, nowhere on the page. That is the cheapest thing on this list, and the only",
